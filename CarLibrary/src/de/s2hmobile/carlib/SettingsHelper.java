...
public class SettingsHelper {
	...
	private static final String PATTERN_GOOGLE_NAVIGATION =
			"google.navigation:q=%1$f,%2$f";
		
	private static final String PATTERN_GENERIC_APP =
			"geo:%1$f,%2$f";
	...
	private static final String 
			INTENT_ACTION_START_MN = "android.intent.action.navigon.START_PUBLIC",
    ...
    public static boolean isCameraEnabled(Context context) {
		...
		boolean defValue = context.getResources()
				.getBoolean(R.bool.pref_camera_default);
	...
	public static Intent getNavigationIntent(Context context,
		...
		String defValue = context.getResources()
				.getString(R.string.routing_default);
		String request = PreferenceManager
		...
		switch (requestId) {
			...
			case VAL_CREATE_CHOOSER:
				...
				String message = context
						.getResources()
						.getString(R.string.dialog_choose_carlib);
	...
	/**
	 * Uses {@link Intent#addFlags(int)} to add the flags 
	 * Intent.FLAG_ACTIVITY_CLEAR_TOP in conjunction with
	 * Intent.FLAG_ACTIVITY_NEW_TASK to the intent.
	...
	/**
	 * Encodes latitude and longitude in a data uri and creates an intent
	 * to view the geolocation. 
	 * @param pattern the template for the data string
